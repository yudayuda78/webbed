    ...
    <div class="max-w-screen-xl mx-auto">
        <div class="max-w-screen-xl mx-auto">
            <div class="mb-5 max-w-screen-xl bg-blue-600 px-5 py-8 rounded-lg">
              <h1 class="mb-1 text-4xl font-extrabold tracking-tight text-white md:text-2xl lg:text-3xl dark:text-white">Tambah Presensi</h1>
              <p class="text-lg font-normal text-gray-50 lg:text-lg dark:text-gray-400">Buat halaman presensi baru dengan memasukan informasi kegiatan dibawah ini</p>
          </div>
      <form class="row g-3 mt-1" action="{{ route('tambahdatapresensi') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div>
            ...
            <div>
                ...
                <input type="text"
                    ...
                    id="slug" name="slug" placeholder="Contoh : AdmMei2_1" required>
            </div>
            <div>
                <label for="telegram" class="mb-2 mt-3 block font-semibold text-sm">Telegram</label>
                <input type="text"
                    class="form-control block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900 focus:border-blue-500 focus:ring-blue-500"
                    id="telegram" name="telegram" placeholder="Masukan link telegram disini" required>
            </div>
            <div>
            ...
            <div>
                <button type="submit"
                    class="mb-2 me-1 mt-5 rounded-lg bg-blue-600  px-4 py-2.5 text-base font-medium text-white hover:bg-blue-800 focus:outline-none focus:ring-4 focus:ring-blue-300">Buat Halaman Presensi</button>
