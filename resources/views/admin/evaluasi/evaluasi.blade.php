    ...
    <div class="mt-14 bg-slate-100 p-4 sm:ml-64">
        <div class="mx-auto max-w-screen-xl">
            ...
            <div class="mb-3 flex justify-between">
                ...
                <a href="{{ route('tambahevaluasi') }}"><button type="submit"
            ...
            <div class="relative mb-5 overflow-x-auto border-x border-t sm:rounded-lg">
                <table class="w-full text-left text-[15px] text-gray-500 dark:text-gray-400 rtl:text-right">
                    ...
                    @foreach ($evaluasi->reverse() as $eval)
                        <tbody>
                            <tr
                                ...
                                <td class="px-6 py-4 font-medium text-gray-900">
                                    <a href="/evaluasi/{{ $eval->slug }}">{{ $eval->judul }}</a>
                                </td>
                                <td class="px-6 py-4 font-medium text-gray-900">
                                    <p>{{ $eval->jumlah_data }} </p>
                                </td>
                                <td class="px-6 py-4 md:whitespace-nowrap">
                                    <p>{{$eval->lasteditedby}}</p>
                                </td>
                                <td class="px-6 py-4 text-right">
                                    <div class="flex flex-col justify-end gap-1 md:flex-row">
                                        <a href="{{ route('isievaluasi', ['evaluasi' => $eval->slug]) }}"
                                        ...
                                        <a href="{{ route('chartevaluasi', ['evaluasi' => $eval->slug]) }}"
                                            class="rounded-lg bg-blue-600 px-3 py-2 text-center text-xs font-medium text-white hover:bg-blue-800 focus:outline-none focus:ring-4 focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"><i
                                                class="ri-pie-chart-line"></i></a>
                                        <a href="{{ route('downloaddataevaluasi', ['id' => $eval->id]) }}"
                                            class="rounded-lg bg-blue-600 px-3 py-2 text-center text-xs font-medium text-white hover:bg-blue-800 focus:outline-none focus:ring-4 focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"><i
                                                class="ri-download-line"></i></a>
                                        <a href="{{ route('editevaluasi', ['id' => $eval->id]) }}"
                                            class="rounded-lg bg-blue-600 px-3 py-2 text-center text-xs font-medium text-white hover:bg-blue-800 focus:outline-none focus:ring-4 focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"><i
                                                class="ri-edit-box-line"></i></a>
                                        <a href="{{ route('hapusdataevaluasi', ['id' => $eval->id]) }}"
                                            class="rounded-lg bg-red-500 px-3 py-2 text-center text-xs font-medium text-white hover:bg-blue-800 focus:outline-none focus:ring-4 focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" onclick="return confirm('Apakah Anda yakin ingin menghapus data ini?');"><i
