...
@section('container')
    ...
    <div class="mt-14 bg-slate-100 p-4 sm:ml-64">
        <div class="mx-auto max-w-screen-xl">
            ...
            <form class="mb-5 max-w-full" action="{{ route('searchevent') }}" method="GET">
            ...
            <div class="mb-3 flex justify-between">
                ...
                <a href="{{ route('tambahevent') }}"><button type="submit"
                        ...
                        <tbody>
                            <tr
                                ...
                                <td class="px-6 py-4 font-medium text-gray-900">
                                    <a href="/event/{{ $event->slug }}">{{ $event->judul }}</a>
                                </td>
                                <td class="px-6 py-4 md:whitespace-nowrap">
                                    <p>{{$event->lasteditedby}}</p>
                                </td>
                                <td class="px-6 py-4 text-right">
                                    <div class="flex flex-col justify-end gap-1 md:flex-row">
                                        ...
                                        <a href="{{ route('hapusdatapendaftaran', ['id' => $event->id]) }}"
