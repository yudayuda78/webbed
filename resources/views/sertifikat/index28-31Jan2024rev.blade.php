...
@section('container')
    ...
    <div class="title-event-container">
        <div class="title-event-wrapper">
            ...
            <p>REVISI  Workshop 40 JP: Implementasi Assesmen </p>
        </div>
    </div>
                ...
                <div class="tablewrapper">
                    <table id="myTable" class="table table-striped">
                        <div class="search-bar">
                            <form action="{{ route('search28-31janrev') }}" method="GET">
                            ...
                            @foreach ($datas as $data)
                                <tr>
                                    ...
                                    <td class="tbld"><button class="btn-sertif btn btn-warning"><a
                                                href="{{ route('sertif.download28janrev', ['id' => $data->id]) }}">Sertifikat</a></button>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
