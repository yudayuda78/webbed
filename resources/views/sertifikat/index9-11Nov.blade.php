        ...
        <div class="tablewrapper">
            <table id="myTable" class="table-striped table">
                <div class="search-bar">
                    <form action="/sertifikat/9-11November/search" method="GET">
