...
@section('container')
    ...
    <div class="title-event-container">
        <div class="title-event-wrapper">
            ...
            <p>Diklat 32JP : Inovasi Pembelajaran Asyik Menggunakan Animasi Pembelajaran Pelaksanaan 13-15 Februari 2024</p>
        </div>
    </div>
                ...
                <div class="tablewrapper">
                    <table id="myTable" class="table table-striped">
                        <div class="search-bar">
                            <form action="{{ route('search13febrev') }}" method="GET">
                            ...
                            @foreach ($datas as $data)
                                <tr>
                                    ...
                                    <td class="tbld"><button class="btn-fasilitas btn btn-warning"><a
                                                href="{{ url('https://drive.google.com/drive/folders/1ndsgpawh7LbJzHIV9F_tAMMD0BnnhdET') }}"
                                                target="blank">Fasilitas</a></button></td>
                                    <td class="tbld"><button class="btn-sertif btn btn-warning"><a
                                                href="{{ route('sertif.download13febrev', ['id' => $data->id]) }}">Sertifikat</a></button>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
