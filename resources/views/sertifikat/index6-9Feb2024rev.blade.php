...
@section('container')
    ...
    <div class="title-event-container">
        <div class="title-event-wrapper">
            <p>Sertifikat</p>
            <p>Workshop 40 JP : Pemanfaatan Artificial intellegence untuk Menyusun Modul Ajar Kurikulum Merdeka dengan Mudah (6-9 Februari)</p>
        </div>
    </div>
                ...
                <div class="tablewrapper">
                    <table id="myTable" class="table table-striped">
                        <div class="search-bar">
                            <form action="{{ route('search6febrev') }}" method="GET">
                            ...
                            @foreach ($datas as $data)
                                <tr>
                                    ...
                                    <td class="tbld"><button class="btn-fasilitas btn btn-warning"><a
                                                href="{{ url('https://drive.google.com/drive/folders/1wBDF-v-B2P0ZODYaifS-tDGZ4_WOeH0p') }}"
                                                target="blank">Fasilitas</a></button></td>
                                    <td class="tbld"><button class="btn-sertif btn btn-warning"><a
                                                href="{{ route('sertif.download6febrev', ['id' => $data->id]) }}">Sertifikat</a></button>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
