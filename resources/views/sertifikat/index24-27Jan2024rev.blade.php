...
@section('container')
    <div class="md:pb-13 bg-[url(/img/ui/bg-sertif.png)] pb-8">
        ...
        <div class="mx-auto max-w-[90%] pt-5 md:max-w-main md:pt-5">
            <p class="md:text-lg text-base text-[#64748B]">Sertifikat Revisi</p>
            <p class="md:text-xl text-lg font-bold">Workshop 40 JP : Pemanfaatan Canva dalam Menyelesaikan Aksi Nyata PMM </p>
        </div>
    </div>
    ...
    <div class="mx-auto max-w-[90%] md:max-w-main mt-6 mb-2 flex justify-between flex-col md:flex-row gap-7">
        <div class="md:w-[789px] w-full">
            <form class="flex gap-2 mb-5" action="{{ route('search24-27janrev') }}" method="GET">
                                    ...
                                    @foreach ($datas as $data)
                                        <tr>
                                            ...
                                            <td class="whitespace-nowrap px-3 py-3 text-sm font-bold text-[#1B7BE7]"><button
                                                    class="btn-fasilitas btn btn-warning"><a
                                                        href="{{ url('https://s.id/FasilitasJan5') }}"
                                                        target="blank">Fasilitas</a></button></td>
                                            <td class="whitespace-nowrap px-3 py-3 text-sm font-bold text-[#1B7BE7]"><button
                                                    class="btn-sertif btn btn-warning"><a
                                                        href="{{ route('sertif.download24janrev', ['id' => $data->id]) }}">Sertifikat</a></button>
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
