...
@section('container')
    ...
    <div class="title-event-container">
        <div class="title-event-wrapper">
            ...
            <p>Workshop 40 JP : Pemanfaatan PMM untuk Pembelajaran dan Peningkatan Kompetensi Guru Pelaksanaan 9-12 Februari 2024</p>
        </div>
    </div>
                ...
                <div class="tablewrapper">
                    <table id="myTable" class="table table-striped">
                        <div class="search-bar">
                            <form action="{{ route('search9-12febrev') }}" method="GET">
                            ...
                            @foreach ($datas as $data)
                                <tr>
                                    ...
                                    <td class="tbld"><button class="btn-fasilitas btn btn-warning"><a
                                                href="{{ url('https://drive.google.com/drive/folders/15Cr94w6ZN4ohBX96jNO41IPkjAvDVKNZ?usp=drive_link') }}"
                                                target="blank">Fasilitas</a></button></td>
                                    <td class="tbld"><button class="btn-sertif btn btn-warning"><a
                                                href="{{ route('sertif.download9febrev', ['id' => $data->id]) }}">Sertifikat</a></button>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
            ...
            <div class="list-event-card card">
                ...
                <div class="card-body">
                    ...
                    <a href="/event/{{ $isi->slug }}">
                        <h5 class="mb-2 judul-event card-title">{{ $isi->judul }}</h5>
                    </a>
                    <p class="mb-2 card-text">{{ $isi->tanggalpelaksanaan }}</p>
                    <a href="#"
