...
@section('container')
    ...
    <div class="title-event-container">
        <div class="title-event-wrapper">
            <p>Sertifikat</p>
            <p>Diklat Nasional 32JP : Persiapan Menyambut Semester Baru pada Kurikulum Merdeka Pelaksanaan 16-19 Desember
                2023
            </p>
        </div>
    </div>
                ...
                <div class="tablewrapper">
                    <table id="myTable" class="table-striped table">
                        <div class="search-bar">
                            <form action="{{ route('search16-19desrev') }}" method="GET">
                            ...
                            @foreach ($datas as $data)
                                <tr>
                                    ...
                                    <td class="tbld"><button class="btn-fasilitas btn btn-warning"><a
                                                href="{{ url('https://s.id/FasilDes2') }}"
                                                target="blank">Download</a></button></td>
                                    <td class="tbld"><button class="btn-sertif btn btn-warning"><a
                                                href="{{ route('sertif.download2desrev', ['id' => $data->id]) }}">Download</a></button>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
