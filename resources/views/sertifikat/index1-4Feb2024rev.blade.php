...
@section('container')
    ...
    <div class="title-event-container">
        <div class="title-event-wrapper">
            ...
            <p>Wiklat 32JP : Pengelolaan Kinerja Guru dan Kepala Sekolah pada Platfrom Merdeka Mengajar 1-4 Februari</p>
        </div>
    </div>
                ...
                <div class="tablewrapper">
                    <table id="myTable" class="table table-striped">
                        <div class="search-bar">
                            <form action="{{ route('search1-4febrev') }}" method="GET">
                            ...
                            @foreach ($datas as $data)
                                <tr>
                                    ...
                                    <td class="tbld"><button class="btn-sertif btn btn-warning"><a
                                                href="{{ route('sertif.download1febrev', ['id' => $data->id]) }}">Sertifikat</a></button>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
