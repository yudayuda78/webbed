...
@section('container')
    ...
    <div class="title-event-container">
        <div class="title-event-wrapper">
            <p>Sertifikat</p>
            <p>Workshop 40 JP : Pemanfaatan Canva dalam Menyelesaikan Aksi Nyata PMM </p>
        </div>
    </div>
                ...
                <div class="tablewrapper">
                    <table id="myTable" class="table-striped table">
                        <div class="search-bar">
                            <form action="{{ route('search27-31jan') }}" method="GET">
                            ...
                            @foreach ($datas as $data)
                                <tr>
                                    ...
                                    <td class="tbld"><button class="btn-fasilitas btn btn-warning"><a
                                                href="{{ url('https://drive.google.com/drive/folders/1rA_fmTwac5FMVM8emadmXync_j-Whtd_?usp=sharing') }}"
                                                target="blank">Fasilitas</a></button></td>
                                    <td class="tbld"><button class="btn-sertif btn btn-warning"><a
                                                href="{{ route('sertif.download27jan', ['id' => $data->id]) }}">Sertifikat</a></button>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
