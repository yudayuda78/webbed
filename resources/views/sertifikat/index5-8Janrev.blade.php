...
@section('container')
    ...
    <div class="title-event-container">
        <div class="title-event-wrapper">
            ...
            <p>Diklat 32JP : Merancang Pembelajaran Kreatif & Inovatif dalam Era Kurikulum Merdeka
            </p>
        </div>
    </div>
                ...
                <div class="tablewrapper">
                    <table id="myTable" class="table-striped table">
                        <div class="search-bar">
                            <form action="{{ route('search5-8desrev') }}" method="GET">
                            ...
                            @foreach ($datas as $data)
                                <tr>
                                    ...
                                    <td class="tbld"><button class="btn-sertif btn btn-warning"><a
                                                href="{{ route('sertif.download5janrev', ['id' => $data->id]) }}">Download</a></button>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
