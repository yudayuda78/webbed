...
@section('container')
    ...
    <div class="sertif-container">
                ...
                <div class="tablewrapper">
                    <table id="myTable" class="table-striped table">
                        <div class="search-bar">
                            <form action="{{ route('search1-4febcd') }}" method="GET">
                            ...
                            @foreach ($datas as $data)
                                <tr>
                                    ...
                                    <td class="tbld"><button class="btn-sertif btn btn-warning"><a
                                                href="{{ route('sertif.download1febcd', ['id' => $data->id]) }}">Sertifikat</a></button>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
        ...
        <script async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-9697129609724227"
            crossorigin="anonymous"></script>
        <!-- vertical -->
        <ins class="adsbygoogle" style="display:block" data-ad-client="ca-pub-9697129609724227" data-ad-slot="7790977021"
