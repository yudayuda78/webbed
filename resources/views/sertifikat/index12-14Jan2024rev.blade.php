...
@section('container')
    ...
    <div class="title-event-container">
        <div class="title-event-wrapper">
            ...
            <p>Diklat 32JP : Kiat Mudah Membuat Media Pembelajaran Interaktif 12-14 Januari 2024
            </p>
        </div>
    </div>
                ...
                <div class="tablewrapper">
                    <table id="myTable" class="table-striped table">
                        <div class="search-bar">
                            <form action="{{ route('search12-14desrev') }}" method="GET">
                            ...
                            @foreach ($datas as $data)
                                <tr>
                                    ...
                                    <td class="tbld"><button class="btn-fasilitas btn btn-warning"><a
                                                href="{{ url('https://bit.ly/FasilitasJan3') }}"
                                                target="blank">Fasilitas</a></button></td>
                                    <td class="tbld"><button class="btn-sertif btn btn-warning"><a
                                                href="{{ route('sertif.download12janrev', ['id' => $data->id]) }}">Sertifikat</a></button>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
