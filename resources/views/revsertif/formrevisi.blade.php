    ...
    <div class="mx-auto max-w-[90%] md:max-w-main mt-6 mb-10 flex justify-between flex-col md:flex-row gap-7">
        <div class="md:w-[789px] w-full">
            <div class="bg-[#EBF5FF] p-7 rounded-lg">
                ...
                <p class="text-[#64748B]">Isikan identitas diri anda untuk Revisi Sertifikat<br><b>Form Revisi Sertifikat ini hanya dapat diakses 1 kali</b><br>Jika terdapat kendala harap hubungi admin</p>
