                ...
                <div
                    ...
                    <div class="space-y-4 p-6 sm:p-8 md:space-y-5">
                        ...
                        <form class="space-y-4 md:space-y-6" action="/pendaftaran/tambahdata" method="POST"
                            ...
                            <div>
                                <h1 class="mb-1 text-lg font-bold text-gray-900 dark:text-white md:text-xl">
                                    Syarat Registrasi
                                </h1>
                                <p class="text-sm leading-relaxed text-gray-500">
                                    Syarat registrasi kegiatan ini adalah mengirimkan informasi ini ke 5 grup pendidik,
                                    bisa Kepala sekolah / Guru / ASN / MGMP / Dosen / Tutor / Mhasiswa / dsb.
                                    <a target="_blank"
                                        href="https://wa.me/?text={{ urlencode("Mari bergabung dengan Saya dalam kegiatan yang diselenggarakan oleh tim Belajar Era Digital dengan judul *{$pendaftaran->judul}* \n\n❇️ Link Pendaftaran : " . url()->current() . "\n❇️ Grup Kegiatan : {$pendaftaran->linktree} \n\n#BelajarAsyik #BelajarEraDigital") }}"
                                        class="me-2 rounded bg-green-200 px-2 py-1 text-xs font-medium text-green-800 hover:bg-green-300">
                            ...
                            <div class="grid grid-cols-1 gap-3 md:grid-cols-2 md:gap-4">
                                ...
                                <div class="col-span-1 md:col-span-2">
                                    <label class="mb-2 block text-sm font-medium text-gray-900 dark:text-white"
                                        for="image5">Screenshot 5</label>
                                    <Input
                                        class="form-control block w-full cursor-pointer rounded-lg border border-gray-300 bg-gray-50 text-sm text-gray-900 file:me-4 file:border-0 file:bg-[##64748B] file:px-3 file:py-2.5 focus:outline-none disabled:pointer-events-none disabled:opacity-50 dark:text-gray-400"
                                        type="file" id="image5" name="image5">
                                </div>
                            </div>
                            <button type="submit"
