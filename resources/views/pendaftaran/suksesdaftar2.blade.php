            ...
            <div class="flex flex-col items-center gap-5 rounded-lg bg-[#EBF5FF] p-7 md:flex-row">
                ...
                <div>
                    ...
                    <a href="{{ $dataDariShow->linktree }}"><button type="button"
                            class="my-2 me-2 rounded-lg bg-[#196ECD] px-3 py-2 text-sm font-medium text-white hover:bg-blue-800 focus:outline-none focus:ring-4 focus:ring-blue-300"><i
                                class="ri-whatsapp-line"></i> Gabung Grup</button>
                    </a>
                    <p class="mt-4 text-lg font-bold">Kunjungi sosial media kami!</p>
                    <div class="mt-3 flex flex-col gap-2 text-center md:flex-row">
                        <a href="https://t.me/eventBED" target="_blank"
                            class="rounded-lg bg-[#56A8DA] px-3 py-2 text-sm font-medium text-white hover:bg-blue-800 focus:outline-none focus:ring-4 focus:ring-blue-300">
                            <i class="ri-telegram-line"></i> Channel Telegram
                        </a>
                        <a href="https://instagram.com/belajarera.digital" target="_blank"
                            class="rounded-lg bg-gradient-to-r from-[#F1B945] to-[#B04CDF] px-3 py-2 text-sm font-medium text-white hover:bg-gradient-to-r hover:from-blue-600 hover:to-red-600 focus:outline-none focus:ring-4 focus:ring-blue-300">
                            <i class="ri-instagram-line"></i> Instagram
                        </a>
                        <a href="https://www.youtube.com/@BelajarEraDigital" target="_blank"
                            class="rounded-lg bg-[#E23C48] px-3 py-2 text-sm font-medium text-white hover:bg-red-800 focus:outline-none focus:ring-4 focus:ring-blue-300">
                            <i class="ri-youtube-line"></i> YouTube
                        </a>
                        <a href="https://bit.ly/KombelPMMBED" target="_blank"
                            class="rounded-lg bg-[#196ECD] px-3 py-2 text-sm font-medium text-white hover:bg-blue-800 focus:outline-none focus:ring-4 focus:ring-blue-300">
                            <i class="ri-group-2-line"></i> Komunitas PMM
                        </a>
                        <a href="{{ $dataDariShow->judul }}" target="_blank"
                            class="rounded-lg bg-green-500 px-3 py-2 text-sm font-medium text-white hover:bg-green-800 focus:outline-none focus:ring-4 focus:ring-blue-300">
                            <i class="ri-customer-service-2-line"></i> Layanan Admin
                        </a>
                    </div>
